...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1;">
    ...
    <div role="article" aria-roledescription="email" aria-label="Property Enquiry Form" lang="en">
                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        ...
                        <p style="margin: 0 0 24px;">
                          You have successfully booked in to view #Property_address on #date & #time.
                        </p>
                        <a href="<?=base_url();?>" style="display: block; font-size: 14px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #7367f0; text-decoration: none;">Click here</a> to view the property
                        <p style="margin: 0 0 24px;">
                            If you would like to cancel the booking you can go to your dashboard and cancel it in schedules section or <a href="#">click here</a>
                        </p>
