...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1;">
    <div style="display: none;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id metus sit amet ligula pulvinar ullamcorper tempus in dui. Praesent sit amet hendrerit magna <?=$site[0]->title;?> Account</div>
                ...
                <td class="sm-py-32 sm-px-24" style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                  <a href="<?=base_url();?>">
                    <?php if(pic($site[0]->logo)) { ?>
                        <img src="<?=pic($site[0]->logo);?>" width="155" alt="<?=$site[0]->title;?>" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                    <?php } else { ?>
                  ...
                  <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        ...
                        <p style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850;"><?=ucfirst($name);?>!</p>
                        <p style="margin: 0 0 24px;">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id metus sit amet ligula pulvinar ullamcorper tempus in dui. Praesent sit amet hendrerit magna
                          <span style="font-weight: 600;"><?=$site[0]->title;?></span>
                        </p>
                        <p style="margin: 0 0 24px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id metus sit amet ligula pulvinar ullamcorper tempus in dui. Praesent sit amet hendrerit magna.</p>
                        ...
                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                              <a href="<?=$link;?>" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; text-decoration: none;">Apply Now &rarr;</a>
                            </td>
                          </tr>
                        </table>
                        <p style="margin: 24px 0;">
                          <span style="font-weight: 600;">Note:</span> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id metus sit amet ligula pulvinar ullamcorper tempus in dui. Praesent sit amet hendrerit magna.
                        </p>
                        <p style="margin: 0;">
