...
<html lang="en" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; --bg-opacity: 1; background-color: #eceff1; background-color: rgba(236, 239, 241, var(--bg-opacity));">
    <div style="display: none;">Book A Viewing</div>
                  ...
                  <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));" bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                        ...
                        <p style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850; color: rgba(255, 88, 80, var(--text-opacity));"><?=ucfirst($name);?>!</p>
                        <p style="margin: 24px 0;">
                          You have successfully booked in to view #PropertyAddress on #Date and #Time
                        </p>
                        <a href="<?=base_url();?>" target="_blank">
                          <img src="images/item.jpg" width="500" alt="Property Image" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                        </a>
                        <p style="margin: 24px 0;">
                            Contact/Get in touch:<br>
                          <span style="font-weight: 600;">#PropertyManagerName/LanlordName</span>
                          <br>#PhoneNumber, #Email
                          <br>#CompanyName 
                        </p>
                        <p style="margin: 24px 0;">
                          If you would like to cancel the booking you can go to your dashboard and cancel it in schedules section or click <a href="<?=base_url();?>" target="_blank">here</a>
                        </p>
                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                        ...
                        <p style="margin: 0 0 16px;">Regards, <br>The <?=$site[0]->title;?> Team</p>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 12px; padding-left: 48px; padding-right: 48px; --text-opacity: 1; color: #eceff1; color: rgba(236, 239, 241, var(--text-opacity));">
                        ...
                        <p style="--text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity));">
                          ...
                          <a href="<?=base_url();?>" target="_blank" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">Terms of Use</a> and
                          <a href="<?=base_url();?>" target="_blank" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">Privacy Policy</a>.
                        </p>
                      </td>
                    </tr>
                    <tr>
