            <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" id="div_983a_0">
                ...
                <div class="kingster-page-title-container kingster-container">
                    <div class="kingster-page-title-content kingster-item-pdlr" id="">
                        ...
                        <h1 class="kingster-page-title" id="h1_983a_0">Contact Us</h1>
                    </div>
                </div>
            </div>
                            ...
                            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                    <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;text-transform: none ;color: #3db166 ;">
                                                        <p><a href="#">+91-9502588612</a></p>
                                                        <p><a href="#">principalvaageswari@gmail.com</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="gdlr-core-pbf-column gdlr-core-column-20">
                                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 20px 0px 20px;">
                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js " data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8">
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 35px ;"><i class=" gdlr-core-icon-item-icon fa fa-globe" style="color: #ffffff ;font-size: 40px ;min-width: 40px ;min-height: 40px ;"></i></div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 25px ;">
                                                    <div class="gdlr-core-title-item-title-wrap clearfix">
                                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 26px ;letter-spacing: 0px ;text-transform: none ;">Follow Us</h3></div>
                                                </div>
                                            </div>
                                            <div class="gdlr-core-pbf-element">
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 0px ;">
                                                    <div class="gdlr-core-text-box-item-content" style="font-size: 16px ;">
                                                        <p>Beside L.M.D Police Station, 
                                                        <br>Ramakrishna Colony, Thimmapur, 
                                                            <br>Karimnagar, Telangana State,
                                                            <br>India – 505527</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="gdlr-core-pbf-element">
                                                <div class="gdlr-core-contact-form-7-item gdlr-core-item-pdlr gdlr-core-item-pdb ">
                                                    <div role="form" class="wpcf7" id="wpcf7-f1979-p1964-o1" lang="en-US" dir="ltr">
                                                        ...
                                                        <form class="quform" action="<?=base_url('contact');?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="quform-element">
                                                                    <p>Your Name (required)
                                                                        ...
                                                                        <span class="wpcf7-form-control-wrap your-name">
                                                                            <input id="name" type="text" name="fullname" value="<?=($mess == '')?set_value('fullname'):'';?>" size="40" class="input1" aria-required="true" aria-invalid="false">
                                                                            <?=form_error('fullname'); ?>
                                                                        </span> 
                                                                    </p>
                                                                </div>
                                                                ...
                                                                <div class="quform-element">
                                                                    <p>Your Email (required)
                                                                        ...
                                                                        <span class="wpcf7-form-control-wrap your-email">
                                                                            <input id="email" type="text" name="email" value="<?=($mess == '')?set_value('email'):'';?>" size="40" class="input1" aria-required="true" aria-invalid="false">
                                                                            <?=form_error('email'); ?>
                                                                        </span> 
                                                                    </p>
                                                                </div>
                                                                <div class="quform-element">
                                                                    <p>Your Message (required)
                                                                        ...
                                                                        <span class="wpcf7-form-control-wrap your-message">
                                                                            <textarea  id="message" name="message" cols="40" rows="10" class="input1" aria-invalid="false"><?=($mess == '')?set_value('message'):'';?></textarea>
                                                                            <?=form_error('message'); ?>
                                                                        </span>
                                                                    </p>
                                                                </div>
