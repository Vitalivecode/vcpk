...
{
    // default connection
    public static $dbname = 'vcpkacin_pharmacy_website'; // Your database name
    public static $dbuser = 'vcpkacin_pharmacy_website'; // Your database username
    public static $dbpass = 'vcpkacin_pharmacy_website'; // // Your database password
